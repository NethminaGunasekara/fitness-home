...
using static fitness_home.Views.Dashboard.Member.Components.Views.ScheduleView;
...
namespace fitness_home.Views.Dashboard.Member.Components.Views
{
    public partial class ScheduleView : UserControl
    {
        ...
        private void DisplayClassDetails(DateTime date)
        {
            ...
            List<ClassDetails> classDetails = ScheduleView.GetScheduleForDay(date, Authentication.LoggedUser.ID, Authentication.LoggedUser.PlanID);
